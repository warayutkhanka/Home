...
extract($row);
?>
<form action="orderupdate_db.php" method="post" name="orderupdate" id="orderupdate">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="117" align="right" bgcolor="#EBEBEB">ชื่อลูกค้า :</td>
      <td width="583" bgcolor="#EBEBEB"><input name="customer_id" type="text" id="customer_id" size="30" placeholder="customer_id"  required="required"  /></td>
    </tr>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ชื่อพนักงาน<label> :</label></td>
      <td bgcolor="#EBEBEB"><input name="employee_id" type="text" id="employee_id"  size="30" placeholder="employee_id"  required="required" "/></td>
    </tr>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">วันสั่งสินค้า :</td>
      <td bgcolor="#EBEBEB"><input type="date" name="order_date" id="order_date" placeholder="วันสิ่งสินค้า"  required="required"/></td>
    </tr>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">วันรับสินค้า :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="date" name="required_date" id="required_date"  placeholder="วันรับสินค้า" required/></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">วันที่จัดส่ง : </td>
      <td bgcolor="#EBEBEB"><input name="shipped_date" type="date" id="shipped_date"  size="30" placeholder="ตัวอย่าง pisit.bow@gmail.com"  required="required"/></td>
    </tr>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ขนส่งผ่าน :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_via" id="ship_via"  placeholder="ขนส่งผ่าน" required/></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ค่าขนส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="freight" id="freight"  placeholder="ค่าขนส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ชื่อผู้จัดส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_name" id="ship_name"  placeholder="ชื่อผู้จัดส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ที่อยู่ผู้จัดส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_address" id="ship_address"  placeholder="ที่อยู่ผู้จัดส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">เมืองขนส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_city" id="ship_city"  placeholder="เมืองขนส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ภูมิภาคผู้ขนส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_region" id="ship_region"  placeholder="ภูมิภาคผู้ขนส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">รหัสไปรษณีย์ของผู้จัดส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_postalcode" id="ship_postalcode"  placeholder="รหัสไปรษณีย์ของผู้จัดส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td align="right" bgcolor="#EBEBEB">ประเทศผู้ขนส่ง :<label> </label></td>
      <td bgcolor="#EBEBEB"><input type="text" name="ship_country" id="ship_country"  placeholder="ประเทศผู้ขนส่ง" required/></td>
    </tr>
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    ...
    <tr>
      <td bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB">&nbsp;
        <input type="button" value=" ยกเลิก " onclick="window.location='adminorder.php' " /> <!-- ถ้าไม่แก้ไขให้กลับไปหน้าแสดงรายการ -->
        &nbsp;
