                        ...
                        <div id="login" class="animate form">
                            <form  action="login_db.php" method="post"> 
                                ...
                                <p class="login button"> 
                                    <input type="submit" name="login_user" id="go" value="Login" /> 
                                </p>
                                <p class="change_link">
                                  Not a member yet ?
                        ...
                        <div id="register" class="animate form">
                          <form action="register_db.php" method="post"> 
                                ...
                                <p> 
                                    ...
                                    <input id="passwordsignup_confirm" name="password_2" required="required" type="password" placeholder="confirm password"/>
                                </p>
